...
describe Hornet::GuildTags do
  ...
  it "audit tag" do
    with_tags do
      ...
      logs[0].guild_id.should eq guild_id
      logs[0].name.should eq "name"
      ...
      logs[1].guild_id.should eq guild_id
      logs[1].name.should eq "name"
      logs[1].action.should eq Hornet::GuildTags::AuditLogAction::Unlock
      logs[1].action_author_id.should eq owner_id

      logs[2].guild_id.should eq guild_id
      logs[2].name.should eq "name"
